 ...
 * Assumption: TRIANGLE MESH.  Normal indices in obj file ignored.
 * Compute vertex normals using the function provided.
 * Vertex normals are required if element array is used.
 */
...
var objParser = {
    ...
    'vn': function () {  //NORMALS ARE IGNORED
...
function loadObjFile (url) {
    ...
    return { vertices: objParser.vertices, faces: objParser.faces };  //Normals not returned!
}

function loadObjTxt(objData) {
    var lines = objData.split('\n');  //<<<<< Input data stored in teapotObj.js
    objParser.reset();
