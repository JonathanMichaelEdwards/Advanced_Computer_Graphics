//  ============================================================================
//  COSC422: Advanced Computer Graphics;  University of Canterbury (2016)
//
//  FILE NAME: CubeDraw.cpp
//  This program displays a texture mapped cube.
//  Required files: Shader.h, Cube.h, loadTGA.h, Cube.vert, Cube.frag
//  Textures:  Brick.tga, Moss.tga
//	Ref:  Exer02.pdf
//  =============================================================================
...
{
	loadTextures();
	GLuint program = createShaderProg("./src/shaders/Cube.vert", "./src/shaders/Cube.frag");
	...
	GLuint texLoc = glGetUniformLocation(program, "tSampler1");  //tex1 is a uniform variable of type Sampler2D in the fragment shader
	glUniform1i(texLoc, 0);    //Assign a value 0 to the variable tex1 to specify that it should use the texture from unit 0.

	// Moss texture
	GLuint texLoc2 = glGetUniformLocation(program, "tSampler2");
