...
{
	loadTextures();
	GLuint program = createShaderProg("PS_Smoke_Soln.vert", "PS_Smoke_Soln.frag");
	...
	GLint texNums[4] = { 0,1,2,3 };
	glUniform1iv(texLoc, 4, texNums);
	...
	*/
	...
	glEnableVertexAttribArray(6);      // texindex
